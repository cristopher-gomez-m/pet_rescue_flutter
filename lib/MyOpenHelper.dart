...
class MyOpenHelper {
  static const String userTableCreate='CREATE TABLE IF NOT EXISTS accounts (id INTEGER PRIMARY KEY AUTOINCREMENT,email TEXT,password TEXT)';
  /*
...
*/
  static const String dbName = 'datosPractica4.db';
